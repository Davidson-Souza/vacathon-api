...
curl -X POST -b "uid=$cookie" -H "Content-Type: application/json" -d '{"name": "example", "email": "eu@example.com", "age":13, "metaInfo":"something"}'  $baseUrl/api/v1/users/updateUser
